...
<form action="<?php echo JRoute::_('index.php?option=com_roombooking&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	...
	<div class="control-group">
		<div class="control-label">
			<?php echo $this->form->getLabel('addon_title'); ?>
		</div>
		<div class="controls">
			<?php echo $this->form->getInput('addon_title') ; ?>
		</div>
	</div>
    
    <div class="control-group">
		<div class="control-label">
			<?php echo $this->form->getLabel('addon_description'); ?>
		</div>
		<div class="controls">
			<?php echo $this->form->getInput('addon_description') ; ?>
		</div>
	</div>
   ...
   <div class="control-group">
	...
	<input type="hidden" name="task" id="task" value="addon.save">
